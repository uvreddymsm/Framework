...
//    protected WebDriver driver;
 ...
 //   extent = new ExtentReports(System.getProperty("user.dir")+"\\Data\\"+ "\\Report Manager\\"+"CA Tracker"+time+".html", true);
    extent = new ExtentReports(System.getProperty("user.dir")+"\\Data\\"+ "\\ReportManager\\"+"Amazon_Application"+time+".html", true);
    //   
	 extent.config()
     .documentTitle("Amazon YUVA")
     .reportName("Amazon Automation Reports");
	 extent
